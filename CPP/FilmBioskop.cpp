...
public:
    ...
    FilmBioskop(int id, string judul, string genre, int durasi, string sutradara, int tahunRilis,
                string studio, double hargaTiket, string jadwalTayang)
        : Film(id, judul, genre, durasi, sutradara, tahunRilis), studio(studio),
          hargaTiket(hargaTiket), jadwalTayang(jadwalTayang)
    {
    }
